...
--
-- Name: recipes_recipes; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.recipes_recipes (
    ...
    CONSTRAINT recipes_recipes_cooking_time_check CHECK ((cooking_time >= 0))
);


ALTER TABLE public.recipes_recipes OWNER TO postgres;

--
-- Name: recipes_recipes_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.recipes_recipes_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.recipes_recipes_id_seq OWNER TO postgres;

--
-- Name: recipes_recipes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.recipes_recipes_id_seq OWNED BY public.recipes_recipes.id;


--
-- Name: recipes_recipesingredients; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.recipes_recipesingredients (
    id bigint NOT NULL,
    amount smallint NOT NULL,
    ingredient_id bigint NOT NULL,
    recipe_id bigint NOT NULL,
    CONSTRAINT recipes_recipesingredients_amount_check CHECK ((amount >= 0))
);


ALTER TABLE public.recipes_recipesingredients OWNER TO postgres;

--
-- Name: recipes_recipesingredients_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.recipes_recipesingredients_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.recipes_recipesingredients_id_seq OWNER TO postgres;

--
-- Name: recipes_recipesingredients_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.recipes_recipesingredients_id_seq OWNED BY public.recipes_recipesingredients.id;


--
-- Name: recipes_recipestags; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.recipes_recipestags (
    id bigint NOT NULL,
    recipe_id bigint NOT NULL,
...
ALTER TABLE public.recipes_recipestags OWNER TO postgres;

--
-- Name: recipes_recipestags_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.recipes_recipestags_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.recipes_recipestags_id_seq OWNER TO postgres;

--
-- Name: recipes_recipestags_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.recipes_recipestags_id_seq OWNED BY public.recipes_recipestags.id;


--
-- Name: recipes_shoppingcart; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.recipes_shoppingcart OWNER TO postgres;

--
-- Name: recipes_shoppingcart_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.recipes_shoppingcart_id_seq OWNER TO postgres;

--
-- Name: recipes_shoppingcart_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: users_follows; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.users_follows OWNER TO postgres;

--
-- Name: users_follows_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.users_follows_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.users_follows_id_seq OWNER TO postgres;

--
-- Name: users_follows_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.users_follows_id_seq OWNED BY public.users_follows.id;
...
--
-- Name: recipes_recipes id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.recipes_recipes ALTER COLUMN id SET DEFAULT nextval('public.recipes_recipes_id_seq'::regclass);


--
-- Name: recipes_recipesingredients id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.recipes_recipesingredients ALTER COLUMN id SET DEFAULT nextval('public.recipes_recipesingredients_id_seq'::regclass);


--
-- Name: recipes_recipestags id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.recipes_recipestags ALTER COLUMN id SET DEFAULT nextval('public.recipes_recipestags_id_seq'::regclass);


--
-- Name: recipes_shoppingcart id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: users_follows id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.users_follows ALTER COLUMN id SET DEFAULT nextval('public.users_follows_id_seq'::regclass);
...
25	Can add Подписка	7	add_follows
26	Can change Подписка	7	change_follows
27	Can delete Подписка	7	delete_follows
28	Can view Подписка	7	view_follows
29	Can add Ингредиент	8	add_ingredients
30	Can change Ингредиент	8	change_ingredients
31	Can delete Ингредиент	8	delete_ingredients
32	Can view Ингредиент	8	view_ingredients
33	Can add Рецепт	9	add_recipes
34	Can change Рецепт	9	change_recipes
35	Can delete Рецепт	9	delete_recipes
36	Can view Рецепт	9	view_recipes
37	Can add Тег	10	add_tags
38	Can change Тег	10	change_tags
39	Can delete Тег	10	delete_tags
40	Can view Тег	10	view_tags
41	Can add Список покупок	11	add_shoppingcart
42	Can change Список покупок	11	change_shoppingcart
43	Can delete Список покупок	11	delete_shoppingcart
44	Can view Список покупок	11	view_shoppingcart
45	Can add recipes tags	12	add_recipestags
46	Can change recipes tags	12	change_recipestags
47	Can delete recipes tags	12	delete_recipestags
48	Can view recipes tags	12	view_recipestags
49	Can add Количество ингредиента	13	add_recipesingredients
50	Can change Количество ингредиента	13	change_recipesingredients
51	Can delete Количество ингредиента	13	delete_recipesingredients
52	Can view Количество ингредиента	13	view_recipesingredients
53	Can add Избранное	14	add_favorites
54	Can change Избранное	14	change_favorites
55	Can delete Избранное	14	delete_favorites
56	Can view Избранное	14	view_favorites
...
9	recipes	recipes
10	recipes	tags
11	recipes	shoppingcart
12	recipes	recipestags
13	recipes	recipesingredients
14	recipes	favorites
15	authtoken	token
...
1	contenttypes	0001_initial	2023-03-28 20:00:21.883748+03
2	contenttypes	0002_remove_content_type_name	2023-03-28 20:00:21.891749+03
3	auth	0001_initial	2023-03-28 20:00:21.954747+03
4	auth	0002_alter_permission_name_max_length	2023-03-28 20:00:21.958747+03
5	auth	0003_alter_user_email_max_length	2023-03-28 20:00:21.962749+03
6	auth	0004_alter_user_username_opts	2023-03-28 20:00:21.967749+03
7	auth	0005_alter_user_last_login_null	2023-03-28 20:00:21.972747+03
8	auth	0006_require_contenttypes_0002	2023-03-28 20:00:21.973747+03
9	auth	0007_alter_validators_add_error_messages	2023-03-28 20:00:21.977749+03
10	auth	0008_alter_user_username_max_length	2023-03-28 20:00:21.982748+03
11	auth	0009_alter_user_last_name_max_length	2023-03-28 20:00:21.987749+03
12	auth	0010_alter_group_name_max_length	2023-03-28 20:00:21.992749+03
13	auth	0011_update_proxy_permissions	2023-03-28 20:00:21.997747+03
14	users	0001_initial	2023-03-28 20:00:22.062748+03
15	admin	0001_initial	2023-03-28 20:00:22.085749+03
16	admin	0002_logentry_remove_auto_add	2023-03-28 20:00:22.091748+03
17	admin	0003_logentry_add_action_flag_choices	2023-03-28 20:00:22.096749+03
18	auth	0012_alter_user_first_name_max_length	2023-03-28 20:00:22.10275+03
19	authtoken	0001_initial	2023-03-28 20:00:22.120748+03
20	authtoken	0002_auto_20160226_1747	2023-03-28 20:00:22.139751+03
21	authtoken	0003_tokenproxy	2023-03-28 20:00:22.141748+03
22	recipes	0001_initial	2023-03-28 20:00:22.298748+03
23	recipes	0002_auto_20230323_1405	2023-03-28 20:00:22.310747+03
24	sessions	0001_initial	2023-03-28 20:00:22.323748+03
25	users	0002_auto_20230321_1415	2023-03-28 20:00:22.338748+03
26	users	0003_auto_20230321_1952	2023-03-28 20:00:22.351749+03
\.
...
f938zp7x1jt5knyr1zeddgtco6ef2emg	.eJxVjEEOwiAQRe_C2hALMoBL9z0DGZhBqgaS0q6Md7dNutDtf-_9twi4LiWsnecwkbiKQZx-t4jpyXUH9MB6bzK1usxTlLsiD9rl2Ihft8P9OyjYy1bbCM7CWSmfNSDTYMBpm8h54piz8xetogew6LQxwICIyaSUGWmTWXy-2jM4gw:1phCgi:Xqg3bGobaRmRAy18rljypjOl1TeHOeYcMzDqb5r_5rA	2023-04-11 20:00:48.233643+03
\.
...
--
-- Data for Name: recipes_recipes; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.recipes_recipes (id, image, name, text, cooking_time, author_id) FROM stdin;
\.


--
-- Data for Name: recipes_recipesingredients; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.recipes_recipesingredients (id, amount, ingredient_id, recipe_id) FROM stdin;
\.


--
-- Data for Name: recipes_recipestags; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.recipes_recipestags (id, recipe_id, tag_id) FROM stdin;
\.


--
-- Data for Name: recipes_shoppingcart; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: users_follows; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.users_follows (id, author_id, user_id) FROM stdin;
\.
...
COPY public.users_user (id, last_login, is_superuser, is_staff, is_active, date_joined, email, username, first_name, last_name, password) FROM stdin;
1	2023-03-28 20:00:48.232631+03	t	t	t	2023-03-28 20:00:33.923973+03	1@m.ru	admin			pbkdf2_sha256$260000$20gya7GWmQQB6aEEa96Enk$EDWXw0N6i9vkNL0inclC5IiBBUdM4f0hmIyyhfx/gPQ=
\.
...
SELECT pg_catalog.setval('public.recipes_favorites_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.recipes_ingredients_id_seq', 2188, true);


--
-- Name: recipes_recipes_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.recipes_recipes_id_seq', 1, false);


--
-- Name: recipes_recipesingredients_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.recipes_recipesingredients_id_seq', 1, false);


--
-- Name: recipes_recipestags_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.recipes_recipestags_id_seq', 1, false);


--
-- Name: recipes_shoppingcart_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
SELECT pg_catalog.setval('public.recipes_tags_id_seq', 1, false);


--
-- Name: users_follows_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.users_follows_id_seq', 1, false);
...
--
-- Name: recipes_recipes recipes_recipes_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.recipes_recipes
    ADD CONSTRAINT recipes_recipes_pkey PRIMARY KEY (id);


--
-- Name: recipes_recipesingredients recipes_recipesingredients_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.recipes_recipesingredients
    ADD CONSTRAINT recipes_recipesingredients_pkey PRIMARY KEY (id);


--
-- Name: recipes_recipestags recipes_recipestags_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.recipes_recipestags
    ADD CONSTRAINT recipes_recipestags_pkey PRIMARY KEY (id);


--
-- Name: recipes_shoppingcart recipes_shoppingcart_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: recipes_tags recipes_tags_color_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.recipes_tags
    ADD CONSTRAINT recipes_tags_color_key UNIQUE (color);
...
--
-- Name: users_follows users_follows_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.users_follows
    ADD CONSTRAINT users_follows_pkey PRIMARY KEY (id);
...
--
-- Name: recipes_recipes_author_id_ce70baba; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX recipes_recipes_author_id_ce70baba ON public.recipes_recipes USING btree (author_id);


--
-- Name: recipes_recipesingredients_ingredient_id_55c63c0f; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX recipes_recipesingredients_ingredient_id_55c63c0f ON public.recipes_recipesingredients USING btree (ingredient_id);


--
-- Name: recipes_recipesingredients_recipe_id_5549253b; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX recipes_recipesingredients_recipe_id_5549253b ON public.recipes_recipesingredients USING btree (recipe_id);


--
-- Name: recipes_recipestags_recipe_id_a70b6153; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX recipes_recipestags_recipe_id_a70b6153 ON public.recipes_recipestags USING btree (recipe_id);


--
-- Name: recipes_recipestags_tag_id_0905810d; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX recipes_recipestags_tag_id_0905810d ON public.recipes_recipestags USING btree (tag_id);


--
-- Name: recipes_shoppingcart_recipe_id_7b01d980; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: recipes_shoppingcart_user_id_9cf94f11; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: recipes_tags_color_0075a418_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX recipes_tags_color_0075a418_like ON public.recipes_tags USING btree (color varchar_pattern_ops);
...
--
-- Name: users_follows_author_id_45e796ae; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX users_follows_author_id_45e796ae ON public.users_follows USING btree (author_id);


--
-- Name: users_follows_user_id_f700c968; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX users_follows_user_id_f700c968 ON public.users_follows USING btree (user_id);
...
--
-- Name: recipes_favorites recipes_favorites_recipe_id_c32e4c09_fk_recipes_recipes_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.recipes_favorites
    ADD CONSTRAINT recipes_favorites_recipe_id_c32e4c09_fk_recipes_recipes_id FOREIGN KEY (recipe_id) REFERENCES public.recipes_recipes(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: recipes_favorites recipes_favorites_user_id_c88637ac_fk_users_user_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.recipes_favorites
    ADD CONSTRAINT recipes_favorites_user_id_c88637ac_fk_users_user_id FOREIGN KEY (user_id) REFERENCES public.users_user(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: recipes_recipes recipes_recipes_author_id_ce70baba_fk_users_user_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.recipes_recipes
    ADD CONSTRAINT recipes_recipes_author_id_ce70baba_fk_users_user_id FOREIGN KEY (author_id) REFERENCES public.users_user(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: recipes_recipesingredients recipes_recipesingre_ingredient_id_55c63c0f_fk_recipes_i; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.recipes_recipesingredients
    ADD CONSTRAINT recipes_recipesingre_ingredient_id_55c63c0f_fk_recipes_i FOREIGN KEY (ingredient_id) REFERENCES public.recipes_ingredients(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: recipes_recipesingredients recipes_recipesingre_recipe_id_5549253b_fk_recipes_r; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.recipes_recipesingredients
    ADD CONSTRAINT recipes_recipesingre_recipe_id_5549253b_fk_recipes_r FOREIGN KEY (recipe_id) REFERENCES public.recipes_recipes(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: recipes_recipestags recipes_recipestags_recipe_id_a70b6153_fk_recipes_recipes_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.recipes_recipestags
    ADD CONSTRAINT recipes_recipestags_recipe_id_a70b6153_fk_recipes_recipes_id FOREIGN KEY (recipe_id) REFERENCES public.recipes_recipes(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: recipes_recipestags recipes_recipestags_tag_id_0905810d_fk_recipes_tags_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.recipes_recipestags
    ADD CONSTRAINT recipes_recipestags_tag_id_0905810d_fk_recipes_tags_id FOREIGN KEY (tag_id) REFERENCES public.recipes_tags(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: recipes_shoppingcart recipes_shoppingcart_recipe_id_7b01d980_fk_recipes_recipes_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.recipes_shoppingcart
    ADD CONSTRAINT recipes_shoppingcart_recipe_id_7b01d980_fk_recipes_recipes_id FOREIGN KEY (recipe_id) REFERENCES public.recipes_recipes(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: recipes_shoppingcart recipes_shoppingcart_user_id_9cf94f11_fk_users_user_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: users_follows users_follows_author_id_45e796ae_fk_users_user_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.users_follows
    ADD CONSTRAINT users_follows_author_id_45e796ae_fk_users_user_id FOREIGN KEY (author_id) REFERENCES public.users_user(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: users_follows users_follows_user_id_f700c968_fk_users_user_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.users_follows
    ADD CONSTRAINT users_follows_user_id_f700c968_fk_users_user_id FOREIGN KEY (user_id) REFERENCES public.users_user(id) DEFERRABLE INITIALLY DEFERRED;
